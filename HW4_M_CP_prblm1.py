'''This is the python scrypt for Homework 4 Problem 1
    ...
    With Max and Cameron Patterson
    
    '''
#answer questions here and dont forget the Sypder variable explorer part!

"""
    Q1: appers the fourth vertor legnthens 
        
    Q2: it appears a geneal overal shape is maintained, but the graph responds 
        to a varied input
"""
...
# set t initial and t final in terms of 
rhs1[0] = t_0
rhs1[nseg] = t_L
